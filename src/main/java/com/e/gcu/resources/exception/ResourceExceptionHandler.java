package com.e.gcu.resources.exception;
...
import com.e.gcu.services.exceptions.AuthorizationException;
import com.e.gcu.services.exceptions.DateIntegrityException;
import com.e.gcu.services.exceptions.FileException;
import com.e.gcu.services.exceptions.ObjectNotFoundException;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> dateIntegrity(DateIntegrityException e, HttpServletRequest request){
		...
		StandardError err = new StandardError(System.currentTimeMillis(), HttpStatus.BAD_REQUEST.value(), "Integridade da dados", e.getMessage(), request.getRequestURI());
